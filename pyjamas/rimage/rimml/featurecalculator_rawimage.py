...
class FeatureCalculatorRawImage(FeatureCalculator):
    ...
    def calculate_features(self, image: numpy.ndarray) -> bool:
        ...
        self.feature_array = numpy.expand_dims(self.image, axis=0)
        self.feature_array = numpy.expand_dims(self.feature_array, axis=self.feature_array.ndim)
